...
export default defineComponent({
  ...
  setup(){
    ...
    const emptySig = ref('data:image/jpeg;base64,')

    
    const clearSignature = ()=>SignaturePadComponent.value.clear();
    const emptySignature = ()=>SignaturePadComponent.value.isEmpty();
    ...
    const confirmReport = async()=>{
      ...
      if(emptySignature() ||signatureImageString.value =='data:,' || signatureImageString.value == emptySig.value ){
